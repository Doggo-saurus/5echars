...
const pickers = createPickers({
  ...
  openRaceDetailsModal: characterDetailsModals.openRaceDetailsModal,
  openSubraceDetailsModal: characterDetailsModals.openSubraceDetailsModal,
  openBackgroundDetailsModal: characterDetailsModals.openBackgroundDetailsModal,
});
...
const events = createEvents({
  ...
  openRacePickerModal: pickers.openRacePickerModal,
  openSubracePickerModal: pickers.openSubracePickerModal,
  openBackgroundPickerModal: pickers.openBackgroundPickerModal,
  openClassPickerModal: pickers.openClassPickerModal,
  openSubclassPickerModal: pickers.openSubclassPickerModal,
  openMulticlassModal,
  openLevelUpModal,
  openSpellDetailsModal: pickers.openSpellDetailsModal,
  openItemDetailsModal: pickers.openItemDetailsModal,
  getCharacterSpellSlotDefaults: spellcastingRules.getCharacterSpellSlotDefaults,
...
const bootstrapApi = createBootstrap({
  ...
  loadCharacterById: persistence.loadCharacterById,
  bootstrapPersistence: persistence.bootstrap,
